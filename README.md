...
4. Create an API key for OKX account access (see How To create a OKX API key?)
   - Note: provide the api access credentials in the .env file
5. Create Service Account for access to google drive and google sheets (see How to Create a Google Service Account?)
